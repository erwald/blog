...
- Use US spelling of words.
- Use US-style dates (e.g. "May 22, 2021") and times.
- Use the Oxford comma.
- Combine quotation marks with punctuation in the British/logical way, placing punctuation outside the quotation marks unless it belongs to the quoted material.
...
- For titles, use these rules based on the APA guidelines:
  ...
  - Capitalize the first word after any sort of strong punctuation (period, colon, semicolon, en-dash)

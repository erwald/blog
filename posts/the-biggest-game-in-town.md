...
![img]({{ '/img/neolithic_revolution.jpeg' | url }})
...
![img]({{ '/img/solarpunk_city.jpeg' | url }})
...
<style>.csl-entry{text-indent: -2em; margin-left: 2em;}</style><div class="csl-bib-body">
  ...
  <div class="csl-entry">Pessoa, Fernando. 2001. <i>The Selected Prose of Fernando Pessoa</i>. Grove Press.</div>

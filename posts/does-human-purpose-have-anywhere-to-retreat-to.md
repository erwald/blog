...
If true, that means many humans will have to radically rethink their purpose in life. Maybe we have to do that even before a superintelligence arrives. Does it make sense to labor away at a great novel if you expect a machine to write, fifty years from now, a thousand far greater novels in mere seconds? Bostrom puts it better:

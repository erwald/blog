...
[^5]: These seem like exactly the sorts of studies that would produce different results in different parts of the world. I have no idea whether any of these observations (if they are right at all) generalize to non-Western populations.
[^6]:
